...
//            static_cast<SLuint32>(sampleConvertOpensles(mCodecContext->sample_rate)),//采样率
...
//    }
//    //注册回调
//    (*pcmBufferQueue)->RegisterCallback(pcmBufferQueue, pcmCallback, 0);
//
//    //设置播放
//    (*operateObject)->SetPlayState(operateObject, SL_PLAYSTATE_PLAYING);
//
//    //采样率*通道数*16bit(2字节)
//    audioOutBuffer = (uint8_t *) av_malloc(
//            mCodecContext->sample_rate * mCodecContext->channels * 2);
//    //启动回调
