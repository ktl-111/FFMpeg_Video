...
import com.norman.android.hdrsample.player.decode.base.FFmpegDecode;
import com.norman.android.hdrsample.player.decode.base.MediaCodecAsyncAdapter;
...
class VideoDecoderImpl extends DecoderImpl implements VideoDecoder {
    ...
    @Override
    protected void onCreate(String mimeType, FileSource fileSource) {
        this.codecMimeType = mimeType;
        // TODO: 2025/3/27 改成ffmpeg
//        mediaCodecAdapter = new MediaCodecAsyncAdapter(mimeType);
        mediaCodecAdapter = new FFmpegDecode(mimeType, fileSource);
    }
    ...
    public boolean isSupport10BitYUV420BufferMode() {
        ...
        boolean support10BitYUV420 = mediaCodecAdapter.isSupport10BitYUV420();
        LogUtils.i(TAG, "isSupport10BitYUV420 " + support10BitYUV420);
        return support10BitYUV420;
    }
    ...
    public boolean isSupportColorFormat(int colorFormat) {
        ...
        boolean supportColorFormat = mediaCodecAdapter.isSupportColorFormat(colorFormat);
        LogUtils.i(TAG, "isSupportColorFormat " + supportColorFormat);
    ...
    static class MediaCodecCallBackWrapper implements MediaCodecAsyncAdapter.CallBack {
        ...
        private final DecodecApi mediaCodecAsyncAdapter;

        public MediaCodecCallBackWrapper(DecodecApi mediaCodecAsyncAdapter, CallBack callBack) {
