...
Java_com_example_nativelib_NativeLib_connectBiliService(JNIEnv *env, jobject thiz, jstring url_) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_nativelib_NativeLib_sendData(JNIEnv *env, jobject thiz, jbyteArray data_, jint len_,
