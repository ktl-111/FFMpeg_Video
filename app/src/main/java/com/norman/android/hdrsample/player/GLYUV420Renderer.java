...
class GLYUV420Renderer extends GLRenderer {
    ...
    public void updateBuffer(ByteBuffer outputBuffer) {
        // TODO: 2025/3/27 写yuv数据
        if (!formatValid) {
            LogUtils.i(TAG, "updateBuffer: !formatValid");
            return;
        }
        ...
        LogUtils.i(TAG, "updateBuffer: start yuv420Type:" + yuv420Type);
        if (yuv420Type == YUV420Type.NV12 || yuv420Type == YUV420Type.NV21) {
            ...
            LogUtils.i(TAG, "updateBuffer: end");
        }
    }
