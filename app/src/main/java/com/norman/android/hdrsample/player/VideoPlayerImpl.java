...
public class VideoPlayerImpl extends DecodePlayerImpl<VideoDecoder, VideoExtractor> implements VideoPlayer {
...
//            LogUtils.i(TAG, "onOutputBufferAvailable: seek 2");
//            return false;
//        }
    ...
    protected void onOutputBufferRender(long presentationTimeUs) {
        long sleepTime = TimeUtil.microToMill(timeSyncer.sync(presentationTimeUs));
        LogUtils.i(TAG, "onOutputBufferRender sleepTime: " + sleepTime + " presentationTimeUs:" + presentationTimeUs);
//        sleepTime = 100;
//        if (sleepTime > 0) {
//            try {
